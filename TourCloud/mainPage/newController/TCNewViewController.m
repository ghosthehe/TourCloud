...
@interface TCNewViewController ()<UIScrollViewDelegate>
...
-(void)setupScrollView
{
    ...
    for (int i = 0; i < kImageMaxCount; i++) {
        ...
        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake( MSScreenWidth() * i, 0, MSScreenWidth(), MSScreenHeight())];
...
-(void)clickStartBtn:(UIButton *)startBtn
{
    ...
    [UIApplication sharedApplication].statusBarHidden = NO;
    window.rootViewController = [[TCTabBarController alloc]init];
